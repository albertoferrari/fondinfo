...
title: 1.8 Fibonacci
figure: images/fun/fib-rabbits.png
...
title: 2.2 Conteggio di singole cifre
figure: images/misc/numbers.jpg
...
title: 2.7 Istogramma in grigio
figure: images/misc/histogram.png
...
title: 2.8 ASCII su più colonne
figure: images/repr/ascii.png
class: large-figure
...
Si procede sempre come macchina da scrivere (una riga sotto l'altra) <br>
Ma `∀ (x, y)` si calcola il codice desiderato: `code=32+y·w+x`<br>
`w` è il numero di colonne, in questo caso 10<br>
Bastano due cicli for annidati, senza liste


---

title: 2.9 Crivello di Eratostene
...
title: 3.1 Classe dei calciatori
figure: images/misc/holly-benji.jpg
...
title: 3.4 Classe delle macchine
figure: images/misc/frogger.png
...
title: 3.8 Classe delle squadre
figure: images/misc/holly-benji.jpg
...
title: 4.1 Stringhe rovesciate, con ricorsione
...
title: 4.2 Classe degli sciatori
...
title: 4.4 Albero di H
figure: images/misc/htree.png
...
title: 4.6 Lettura in lista di liste
...
title: 4.7 Documenti e cartelle
...
title: 4.8 Ultimo aggiornamento
figure: images/misc/sample-file-system.png
...
title: Pac-Man - Controllo dei muri
...
- *Muri*
    ...
    - Disposti come blocchetti virtuali di `8x8` pixel, o multipli
    - Metà dimensione di Pac-Man e fantasmi (`16x16` pixel)
- I personaggi possono svoltare solo su coordinate multiple di `8x8` pixel!
...
title: Pac-Man
figure: images/misc/pacman-scatter.png
