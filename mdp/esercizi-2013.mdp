...
title: 1.2 Radici
figure: images/misc/roots2.png

- Calcolare le due radici reali di un’equazione di secondo grado: `ax^^2^^ + bx + c = 0`
    - Valori dei parametri `a`, `b` e `c` immessi dall’utente
    - Valori di `x~~1~~` e `x~~2~~` calcolati dal programma
...
title: 2.4 Matrice di valori

- Chiedere all'utente `n`, il lato di una matrice quadrata
    - Chiedere all'utente di inserire gli `n^^2^^` valori della matrice
...
title: 2.7 File, parentesi
figure: images/misc/brackets.svg
...
title: 2.8 Lettura matrice da file
...
title: 2.9 Lettura matrice da file
...
- Metodi pubblici per ottenere...
    - Area
    - Distanza dei fuochi dal centro: `√(a^^2^^ - b^^2^^)`
...
title: 3.6 Calcolo delle calorie
figure: images/misc/fast-food.jpg
...
title: 3.8 Crivello di Eratostene
...
Usare il metodo `remove` della lista, oppure usare una lista di `bool` <br>
Lista scorsa con un `for`: sconsigliato rimuovere o inserire elementi

---

title: 3.9 Parole più lunghe
...
Si può ordinare una lista tramite il metodo `sort`. In questo caso: <br>
...
title: 4.1 Ricorsione, palindromo
...
title: 4.2 Fila indiana
figure: images/misc/koala-file.jpg
...
Ad ogni turno: aggiungere nuova coppia `(x, y)` per elemento di testa, rimuovere elemento di coda <br>
Es. `v.insert(0, new_pos), v.pop()` <br>
...
title: 4.5 Spirale
figure: images/misc/outward-spiral.png
...
Tenere traccia della direzione attuale (∆x, ∆y) <br>
...
title: 4.7 Fila di riquadri
figure: images/misc/box-layout.png
...
- Classe che modella una fila verticale di riquadri
    ...
    - Metodo: calcolo riquadro virtuale contenente l'intera fila: `w = max(w~~i~~)`, `h = Σ h~~i~~`
- Nel `main`, in un ciclo
...
title: 4.8 Gestione di riquadri
...
title: 4.9 File verticali e orizzontali
figure: images/misc/flow-layout.png
class: large-figure
...
Per il serpente, usare una lista di tuple, ossia coppie (x, y) <br>
...
title: Snake con Pygame
figure: images/oop/pygame-logo.png
