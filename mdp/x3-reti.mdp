...
title: Collegamento
figure: images/sys/topologies.svg
class: large-figure
...
title: Internet
figure: images/sys/internet-nodes.png
...
- Indirizzi a **128 bit**
    - Numero di indirizzi IPv6 / m^^2^^ sulla Terra (6,66×10^^23^^) > Numero di Avogadro!
...
title: Linguaggio PHP
figure: images/sys/php-logo.jpg
...
title: Linguaggio JavaScript
figure: images/repr/html5-logo.svg images/sys/pacman-js.png
...
figure: images/sys/http-url.png
